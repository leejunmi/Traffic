...
# # 이미지 불러오기
# img = cv2.imread('/home/leejunmi/T/TT.png')  # 이미지 경로 수정
...
class TrafficLightDetector:
    def __init__(self, image, x, y, w, h):
        ...
        self.yellow_lower = np.array([20, 85, 85])  # 수정된 값
        self.yellow_upper = np.array([35, 255, 255])  # 수정된 값 # 30 -> 35

        self.green_lower = np.array([35, 60, 60])  # 수정된 값
...
img = cv2.imread('/home/leejunmi/T/TT.png')
